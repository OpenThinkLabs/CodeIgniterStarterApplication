...
<body>
    <div id="contextWrap">
        ...
        <div class="ui sidebar vertical left menu overlay  borderless visible sidemenu inverted  grey" style="-webkit-transition-duration: 0.1s; transition-duration: 0.1s;" data-color="grey">
            <a class="item logo" href="index.html">
                <img src="assets/images/logo.png" alt="logo"/><img src="assets/images/logo.png" alt="logo" class="displaynone" />
            </a>
            <div class="ui accordion inverted">
                ...
                <div class="title item">
                    ...
                    <i class="dropdown icon"></i> Nasabah
                </div>
                <div class="content">
                    <a class="item" href="#">
                    Pengajuan Nasabah
            ...
            <a class="item">
                <div class="ui inverted progress tiny yellow" id="sidebar_progress1">
                    ...
                    <div class="label colhidden" style="margin-top: 10px"><span class="colhidden">Indikator 1</span></div>
                </div>
            ...
            <a class="item">
                <div class="ui inverted progress tiny teal" id="sidebar_progress2">
                    ...
                    <div class="label colhidden" style="margin-top: 10px"><span class="colhidden">Indikator 2</span></div>
                </div>
            ...
            <a class="item">
                <div class="ui inverted progress tiny blue" id="sidebar_progress3">
                    ...
                    <div class="label colhidden" style="margin-top: 10px"><span class="colhidden">Indikator 3</span></div>
                </div>
            ...
            <a class="item hiddenCollapse">
                <div class="ui one tiny inverted statistics">
                    ...
                    <div class="statistic">
                        <div class="value">
                            <img src="/assets/images/avatar/people/carol.png" class="ui circular inline  top aligned image"><span class="counter">212</span>
                        </div>
                        <div class="label">
                            Team Members
                        </div>
        ...
        <div class="ui right sidebar">
            ...
            <div class="ui tab active" data-tab="first">
                <div class="ui small feed">
                    <h4 class="ui header">Nasabah Activity</h4>
                    <div class="event">
                        <div class="label">
                    ...
                    <div class="right menu colhidden">
                        ...
                        <div class="ui dropdown item labeled icon">
                            ...
                            <div class="menu">
                                ...
                                <div class="item">
                                    <img class="ui avatar image" src="/assets/images/avatar/people/carol.png" alt="label-image" /> Janice Robinson
                                </div>
                                <div class="item">
                                    <img class="ui avatar image" src="/assets/images/avatar/people/carol.png" alt="label-image" /> Cynthia May
                                </div>
                                <div class="item">
                                    <img class="ui avatar image" src="/assets/images/avatar/people/carol.png" alt="label-image" /> Hugh Carter
                                </div>
                                <div class="header">
                                    Your Friends' Friends
                                </div>
                                <div class="item">
                                    <img class="ui avatar image" src="/assets/images/avatar/people/carol.png" alt="label-image" /> Pauline Cain
                                </div>
                                <div class="item">
                                    <img class="ui avatar image" src="/assets/images/avatar/people/carol.png" alt="label-image" /> Marco Beck
                                </div>
                                <div class="item">
                                    <img class="ui avatar image" src="/assets/images/avatar/people/carol.png" alt="label-image" /> Sue Quinn
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="ui dropdown item">
                            <img class="ui mini circular image" src="/assets/images/avatar/people/carol.png" alt="label-image" />
                            <div class="menu">
                                ...
                                <a class="item" href="<?php echo base_url('logout'); ?>"><?php echo lang('core button logout'); ?></a>
                            </div>
                        </div>
                       <?php endif; ?>
    ...
    <script src="assets/themes/semantic/js/jquery-3.1.1.min.js"></script>    
    <script src="assets/themes/semantic/dist/semantic.min.js"></script>        
    <script src="assets/themes/semantic/plugins/cookie/js.cookie.js"></script>        
    <script src="assets/themes/semantic/plugins/nicescrool/jquery.nicescroll.min.js"></script>
    <script data-pace-options='{ "ajax": false }' src="assets/themes/semantic/plugins/pacejs/pace.js"></script>
    <script src="assets/themes/semantic/js/dashboard2.js"></script>
    <script src="assets/themes/semantic/js/main.js"></script>
</body>
